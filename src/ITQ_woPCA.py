...
with open('df_query3_swinL_ddp_384-48-tta.pkl', 'rb') as f:
    df_query_ = pickle.load(f)
with open('df_gallery3_swinL_ddp_384-48-tta.pkl', 'rb') as f:
...
checkpoint = train(train_data=train_data,code_length=48,max_iter=600,device='cuda')
